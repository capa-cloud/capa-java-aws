...
public class CloundWatchLongHistogram extends CapaLongHistogramSpi implements BoundLongHistogram {
    ...
    public CloundWatchLongHistogram(String meterName, String schemaUrl, String version, String name,
    ...
    public BoundLongHistogram bind(Attributes attributes) {
        CloundWatchLongHistogram copy = new CloundWatchLongHistogram(meterName, schemaUrl, version, name, description, unit);
        if (attributes != null) {
